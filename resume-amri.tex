...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        minimum height=80pt] at (midpoint) {
            \begin{tabular}{c}
                ...
                \href{https://www.linkedin.com/in/amri-rasyidi/}{\fontsize{14}{20}\faLinkedin}
                \href{https://github.com/amrirasyidi}{\fontsize{14}{20}\faGithub}
                \href{https://longlivecomrade9.wordpress.com/}{\fontsize{14}{20}\faWordpress}
            \end{tabular}
        };
    \end{tikzpicture}
    ...
    \vspace{-5pt}
    \resumeItemListStart
    \resumeItem{Banking Industry Solutioning:}{ developed 2 advanced analytics solutions.}
    \resumeItemListEnd
