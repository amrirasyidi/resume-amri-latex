...
\begin{document}
    ...
    % \vspace{-15pt}
    \resumeItemListStart
    \resumeItem{Machine Learning, Deep Learning, MLOps:}{ % (optional) [soon]
        PyTorch, (scikit-learn), XGBoost, (statsmodel), MLFlow, Optuna, [TensorFlow, Darts, DVC]
    }
    \resumeItem{Data Science:}{
        VSCode, GeoPandas, Apache-Sedona, polars, ydata-profiling, SQL, Neo4j, Cypher, ArcGIS Pro
    }
    \resumeItem{Deployment:}{
        Git, GitHub, DagsHub, [Gradio, HuggingFace, Azure, AWS]
    }
