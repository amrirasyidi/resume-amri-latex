...
\begin{document}
    ...
    \resumeItem{Data Science:}{
        VSCode, GeoPandas, Apache-Sedona, polars, ydata-profiling, BigQuery SQL,
        ArcGIS Pro
    ...
    \resumeItem{Air Quality Index (AQI) Forecasting:}{ developed and compared novel
    timeseries forecasting methods pipeline to forecast the next 48 hours of AQI trends.
    Designed and automated experimentation process using Optuna resulted in
    $>$80 experiment combinations and used MLflow and Dagshub to monitor the result.
    Best model achieve RMSE of $\sim$7.14 with data ranged from 40-160.
    }
    \resumeItemListEnd
    ...
    \vspace{-5pt}
    \resumeItemListStart
    \resumeItem{Designed and created:}{ data analysis lecture materials (Python and SQL
    for data analysis).}
