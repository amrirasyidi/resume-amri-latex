    ...
    \begin{tikzpicture}[remember picture,overlay]
        ...
        minimum height=80pt] at (midpoint) {
            \begin{tabular}{c}
                ...
                \href{https://www.linkedin.com/in/amri-rasyidi/}{\fontsize{14}{20}\faLinkedinSquare ~Amri Rasyidi}
                \href{https://github.com/amrirasyidi}{\fontsize{14}{20}\faGithub ~amrirasyidi}
                \href{https://longlivecomrade9.wordpress.com/}{\fontsize{14}{20}\faWordpress ~longlivecomrade9}
            \end{tabular}
        };
    \end{tikzpicture}
