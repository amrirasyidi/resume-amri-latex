...
\vspace{-1pt}
\resumeItemListStart
\resumeItem{Custom Web-based Computer Vision Application:}{ Led a team of 4 engineers to successfully develop and deploy a custom web-based computer vision application within 7 weeks, utilizing Python API for ArcGIS to build and deploy deep learning models.
}
