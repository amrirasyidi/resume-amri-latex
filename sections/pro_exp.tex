\resumeSubheading
{ESRI Indonesia (GIS Software \& Services)}
{Jakarta, Indonesia}
{Data Scientist}
...
\vspace{-1pt}
\resumeItemListStart
\resumeItem{Custom Web-based Computer Vision Application:}{ Led a team of 4 engineers to successfully develop and deploy a custom web-based computer vision application within 7 weeks, utilizing Python API for ArcGIS to build and deploy deep learning models. The initial model achieved 82\% mean Average Precision (mAP).
}
\resumeItem{Automated Computer Vision System:}{ Spearheaded the end-to-end development of a system, including building the back-end service to receive submissions from a mobile app, developing a deep learning model for object detection, and creating a dashboard for real-time reporting and insights.
}
\resumeItem{Palm Tree Counting:}{ Led a palm tree counting project, overseeing data labeling of over 7000 data points on drone imageries, consulting with the reporting, and utilizing ArcGIS Pro for data preparation. Trained a deep learning model and managed performance analysis, resulting in an exceptional 95\% mean Average Precision (mAP).
}
